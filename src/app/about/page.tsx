...
const About = () => {
  return (
    <div className="bg-black p-14 text-white min-h-screen">
      {/* Hero Section */}
      ...
      {/* Highlights Section */}
      <section className="relative z-10 py-20 px-4 bg-slate-900/50 rounded-xl shadow-inner shadow-cyan-800/10 mt-10">
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }}
          className="text-center text-3xl md:text-4xl font-bold text-cyan-400 mb-4 tracking-tight"
        >
          What We Stand For
        </motion.h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-32 h-1 bg-cyan-500 mx-auto rounded mb-8 origin-center"
        />
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-center text-neutral-400 text-base max-w-2xl mx-auto mb-16"
        >
              ...
              <p className="text-neutral-400 text-sm leading-relaxed transition-colors duration-300 group-hover:text-cyan-200">
                {
                  [
                    ...
                    "Build AI-assisted tools, collaborative workspaces, and launching tracks for data science and DevOps.",
                  ][idx]
                }
              </p>
            </motion.div>
  ...
  <motion.h2
    ...
    transition={{ duration: 0.6, ease: "easeOut" }}
    viewport={{ once: true }}
    className="text-center text-4xl font-extrabold mb-16 text-cyan-400"
  >
