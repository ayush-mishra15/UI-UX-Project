    ...
    <div className="bg-black text-gray-400 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4 sm:px-6 md:px-7 lg:px-8">
        ...
        <div>
          ...
          <p>
            We provide hands-on web development courses designed to take you
            from beginner to pro. Learn HTML, CSS, JavaScript, React, and more
            with real-world projects and expert guidance.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Email:{" "}
            <a
              href="mailto:support@webschool.com"
